...
@section('content')
    ...
    <div class="container" style="max-width:500px">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('faculty_registration') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <H5 class="header">Registering as a Faculty</H5>

                    <label for="inputIdNumber" class="sr-only">I.D. Number</label>
                    <input type="text" value="{{ old('id_number') }}" id="id_number" name="id_number"
