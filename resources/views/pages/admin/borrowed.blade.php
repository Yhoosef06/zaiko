...
@endsection
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="POST" action="{{ route('borrow_item', ['id' => $borrows->id, 'serial_number' => $borrows->serial_number]) }}">
                            @csrf
                              <div class="mb-3">
                              <input type="hidden" name="id" value="{{ $borrows->id }}">
                                <input type="hidden" name="serial_number" value="{{ $borrows->serial_number }}">
