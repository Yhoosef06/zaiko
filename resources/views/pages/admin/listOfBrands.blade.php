                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> <strong>List of All Brands</strong> </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-primary" data-toggle="modal"
                                                    ...
                                                    onclick="openItemModal('{{ $brand->id }}')">
                                                    <i class="fa fa-eye"></i>
                                                </button>

                                                <form class="form_delete_btn" method="POST"
                                                    action="{{ route('delete_item', $brand->id) }}">
                                                    @csrf
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('edit_item_details', ['id' => $brand->id]) }}" class="btn btn-primary">Edit</a>
                </div>
            </div>
        </div>
    </div>
